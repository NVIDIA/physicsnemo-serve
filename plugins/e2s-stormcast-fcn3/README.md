...
```bash
python scripts/plugin_dev.py check plugins/e2s-stormcast-fcn3
python scripts/plugin_dev.py check-env plugins/e2s-stormcast-fcn3
python scripts/plugin_dev.py run-local plugins/e2s-stormcast-fcn3 --dry-run
```
