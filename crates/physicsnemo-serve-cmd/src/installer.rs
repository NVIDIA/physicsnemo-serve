...
fn uv_asset() -> Result<(&'static str, &'static str)> {
    match (std::env::consts::OS, std::env::consts::ARCH) {
        ("linux", "x86_64") => Ok(("uv-x86_64-unknown-linux-gnu.tar.gz", UV_LINUX_X86_64_SHA256)),
        ("linux", "aarch64") => Ok((
            "uv-aarch64-unknown-linux-gnu.tar.gz",
            UV_LINUX_AARCH64_SHA256,
        )),
        ("macos", "x86_64") => Ok(("uv-x86_64-apple-darwin.tar.gz", UV_MACOS_X86_64_SHA256)),
        ("macos", "aarch64") => Ok(("uv-aarch64-apple-darwin.tar.gz", UV_MACOS_AARCH64_SHA256)),
