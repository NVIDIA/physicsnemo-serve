...
```bash
python scripts/plugin_dev.py check plugins/e2s-diagnostic
python scripts/plugin_dev.py check-env plugins/e2s-diagnostic
python scripts/plugin_dev.py run-local plugins/e2s-diagnostic --dry-run
```
