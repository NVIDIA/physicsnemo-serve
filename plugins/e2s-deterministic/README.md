...
```bash
python scripts/plugin_dev.py check plugins/e2s-deterministic
python scripts/plugin_dev.py check-env plugins/e2s-deterministic
python scripts/plugin_dev.py run-local plugins/e2s-deterministic --dry-run
```
